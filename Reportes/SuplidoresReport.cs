...
namespace ProyectoFinal_PA2.Reportes
{
    public class SuplidoresReport
    {
        ...
        public byte[] Reporte(List<Suplidores> suplidores)
        {
            listaSuplidores = suplidores;
            ...
            anchoColumnas[0] = 300; //Esta sera la fila 1 SuplidorId
            anchoColumnas[1] = 300; //Esta sera la fila 2 Nombre Suplidor
            anchoColumnas[2] = 300; //Esta sera la fila 3 Apellido
            anchoColumnas[3] = 300; //Esta sera la fila 4 Nombre Compañia
        ...
        private void ReportBody()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Nombres Suplidor", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            pdfCell = new PdfPCell(new Phrase("Nombre Compañia", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            pdfCell = new PdfPCell(new Phrase("Ciudad", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            foreach (var item in listaSuplidores)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.NombreSuplidor.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
                ...
                pdfCell = new PdfPCell(new Phrase(item.NombreCompañia.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
                ...
                pdfCell = new PdfPCell(new Phrase(item.Ciudad.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
