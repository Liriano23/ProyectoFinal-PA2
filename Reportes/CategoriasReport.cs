...
namespace ProyectoFinal_PA2.Reportes
{
    public class CategoriasReport
    {
        ...
        public byte[] Reporte(List<Categorias> categorias)
        {
            ...
            anchoColumnas[0] = 50; //Esta sera la fila 1 categoriaid
            anchoColumnas[1] = 200; //Esta sera la fila 2 Nombre
            anchoColumnas[2] = 60; //Esta sera la fila 3 fecha
            anchoColumnas[3] = 50; //Esta sera la fila 4 usuario
        ...
        private void ReportBody()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Nombre Categoria", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            foreach (var item in listaCategorias)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.NombreCategoria.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;  
                pdfTable.AddCell(pdfCell);
