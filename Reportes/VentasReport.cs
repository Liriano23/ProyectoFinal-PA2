...
namespace ProyectoFinal_PA2.Reportes
{
    public class VentasReport
    {
        ...
        public byte[] Reporte(List<Ventas> ventas)
        {
            listaVentas = ventas;
            ...
            anchoColumnas[0] = 300; //Esta sera la fila 1 VentasId
            anchoColumnas[1] = 300; //Esta sera la fila 2 ClienteId
            anchoColumnas[2] = 300; //Esta sera la fila 3 EmpleadoID
            anchoColumnas[3] = 300; //Esta sera la fila 4 Fecha Venta
            anchoColumnas[4] = 300; //Esta sera la fila 5 SubTotal
            anchoColumnas[5] = 300; //Esta sera la fila 6 ITBIS
            anchoColumnas[6] = 300; //Esta sera la fila 7 Descuento
            anchoColumnas[7] = 300; //Esta sera la fila 8 Total
            anchoColumnas[8] = 300; //Esta sera la fila 9 UsuarioID
        ...
        private void ReportBody()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("EmpleadoID", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);

            pdfCell = new PdfPCell(new Phrase("Fecha de Venta", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            pdfCell = new PdfPCell(new Phrase("Descuento", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            foreach (var item in listaVentas)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.FechaEmision.ToString("dd/MM/yyyy"), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
                ...
                pdfCell = new PdfPCell(new Phrase(item.Descuento.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
            ...
            pdfCell = new PdfPCell(new Phrase(subtotal.ToString(), fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.White;
            pdfCell.Border = 0;
            ...
            pdfCell = new PdfPCell(new Phrase(descuento.ToString(), fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.White;
            pdfCell.Border = 0;
