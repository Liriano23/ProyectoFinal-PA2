...
namespace ProyectoFinal_PA2.Reportes
{
    public class UsuariosReport
    {
        ...
        public byte[] Reporte(List<Usuarios> usuarios)
        {
            ...
            anchoColumnas[0] = 300; //Esta sera la fila 1 UsuarioID
            ...
            anchoColumnas[4] = 300; //Esta sera la fila 5 Sexo
            anchoColumnas[5] = 300; //Esta sera la fila 6 Direccion
            anchoColumnas[6] = 300; //Esta sera la fila 7 Telefono
            anchoColumnas[7] = 300; //Esta sera la fila 8 Celular
            anchoColumnas[8] = 400; //Esta sera la fila 9 Email
            anchoColumnas[9] = 400; //Esta sera la fila 10 FechaIngreso
            anchoColumnas[10] = 400; //Esta sera la fila 11 Tipo de usuario
            anchoColumnas[11] = 300; //Esta sera la fila 12 Nombre usuario
        ...
        private void ReportBody()
        {
            ...
            foreach (var item in listaUsuarios)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.Sexo.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
                ...
                pdfCell = new PdfPCell(new Phrase(item.TipoUsuario.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
