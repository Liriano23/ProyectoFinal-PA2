...
namespace ProyectoFinal_PA2.Reportes
{
    public class ClientesReport
    {
        ...
        public byte[] Reporte(List<Clientes> clientes)
        {
            ...
            anchoColumnas[0] = 300; //Esta sera la fila 1 ClienteId
            ...
            anchoColumnas[9] = 400; //Esta sera la fila 10 FechaNacimineto
            anchoColumnas[10] = 400; //Esta sera la fila 11 FechaIngreso
            anchoColumnas[11] = 300; //Esta sera la fila 12 usuarioId
